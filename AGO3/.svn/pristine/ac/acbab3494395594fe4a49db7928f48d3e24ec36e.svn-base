				...
				<div class="col-7">
					...
					<div class="card row">
						<!-- <div class="card-header">
							<h3 class="card-title font-weight-bold">자주묻는 질문 목록</h3>
						</div> -->
						<div class="card-body p-0"  style="height: 645px;">
				...
				<div class="col-5 pr-1">
					...
					<div class="card bg-success" style="height: 222px;">
						...
						<div class="card-body p-0 bg-light"  style="height: 219px;">
							<table class="table table-sm" id="test">
								<thead>
									<tr class="text-center" style="background-color: #E6EFFC; color: black;">
										<th >번호</th>
