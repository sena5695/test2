...
<body>
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<%=request.getContextPath()%>/resources/img/logo2.png" alt="AGOLogo">
  </div>
...
// 	$(aTag).parent().style.backgroundColor = "#E6EFFC";
	...
	$(aTag).parent().css("background-color","#F5F4F4");
}
...
{{#each .}}
    <li class="nav-item d-none d-sm-inline-block subMenu py-2">
