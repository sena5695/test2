								...
								<tr>
									...
									<td scope="col" class="pl-4 col-2">
										<select name="askSort" class="form-control form-control-sm col-10">
											<option>분류</option>
											<option value="c" ${faq.askSort eq 'c' ? 'selected' : '' }>수료 문의</option>
											<option value="l" ${faq.askSort eq 'l' ? 'selected' : '' }>학습 문의</option>
											<option value="e" ${faq.askSort eq 'e' ? 'selected' : '' }>기타</option>
										</select>
									</td>
									<td scope="col" class="font-weight-bold text-center" style="width: 10%; background-color: #F5F4F4;">제목</td>
									<td scope="col" class="pl-4">
										<input type="text" class="form-control form-control-sm" name="faqQuestion" value="${ faq.faqQuestion }" />
									</td>
								</tr>
								<tr>
									<td colspan="4">
									<textarea class="textarea form-control" name="faqAnswer" id="content" rows="20" placeholder="1000자 내외로  작성하세요." style="display: none;">${ faq.faqAnswer }</textarea>
