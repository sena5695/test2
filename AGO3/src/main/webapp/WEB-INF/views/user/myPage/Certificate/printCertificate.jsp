...
<body>
	<div>
		...
		<div id="onlyPrint" class="paper p-0">
			<div class="mx-auto row" id="UserCtfDesign" data-id="${certificate.ctfDesign}" style="margin-top: 11mm; border: 3px solid red; height: 1280px; width: 100%; display: inline-block; margin-left: auto; margin-right: auto; background-size: :90%;">
							...
							<tbody>
								...
								<tr>
									<td colspan="5" class="text-center mt-4 pt-5">
										...
										<div id="UserCtfSeal" data-id="${certificate.ctfSeal}" style="width: 120px; height: 120px; position: relative; right: -540px; top: -90px;"></div>
									</td>
								</tr>
		...
		<div id="onlyShow" class="paper p-0 pt-5">
			<div class="mx-auto row" id="UserCtfDesignShow" data-id="${certificate.ctfDesign}" style="margin-top: 8mm; border: 3px solid red; height: 100%; width: 100%; display: inline-block; margin-left: auto; margin-right: auto; background-color: black;">
				<div class="content" style="border: 3px solid blue; padding: 20mm;">
					<div class="container-fluid capture_area" id="pdf_wrap" style="padding: 0px;">
						<div class="col-12 float-left mt-5" style="font-size: 18px; font-family: 'Nanum Myeongjo', serif;">
							제
						...
						<table>
							<tbody>
								...
								<tr>
									<td colspan="5" class="text-center mt-4 pt-5">
										<span class="mt-5 mr-1" style="font-size: 35px; font-family: 'Nanum Myeongjo', serif;">${certificate.retName}</span>
										<div id="UserCtfSealShow" data-id="${certificate.ctfSeal}" style="width: 120px; height: 120px; position: relative; right: -450px; top: -80px;"></div>
									</td>
								</tr>
